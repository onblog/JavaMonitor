package com.github.onblog.java_monitor.timer.config;

import com.github.onblog.java_monitor.timer.job.ClearJob;
import com.github.onblog.java_monitor.timer.job.UpdataJob;
import com.github.onblog.java_monitor.timer.parm.CronParm;
import org.quartz.*;
...
/**
 * Create by Martin 2018/11/14 0014 21:05
 */
@Configuration
