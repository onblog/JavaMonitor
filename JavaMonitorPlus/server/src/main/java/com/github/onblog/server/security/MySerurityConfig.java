package com.github.onblog.server.security;

import com.github.onblog.server.security.encode.MyPasswordEncoder;
import com.github.onblog.server.security.parm.SerurityParm;
...
/**
 * Create by Martin 2018/12/31 0031 19:45
 */
@EnableWebSecurity
